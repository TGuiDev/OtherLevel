...
const option2Content = {
  preco: 'R$ 75,00',
  beneficios: 'Benefício B',
  dias: 'Terça, Quinta',
  outros: 'Outra informação adicional',
};
...
const option3Content = {
  ...
  dias: 'Sábado, Domingo',
  outros: 'Mais uma indo adicionajjjjjjjjjjjjjjjjjjjjjjjjjjjjjjj j jjjjj jj jjjl',
};
...
function updateCardContent(content) {
  ...
  cardInfo1.innerHTML = `Benefícios: ${content.beneficios}<br>Dias: ${content.dias}<br>Outros: ${content.outros}`;
